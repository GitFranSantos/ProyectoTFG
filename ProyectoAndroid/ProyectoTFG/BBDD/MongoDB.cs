...
namespace ProyectoTFG.BBDD
{
    public class MongoDB
    {
        ...
        private readonly string _connectionString = "mongodb://fjsantosestudios:XI04Z055YlOuuxq5@ac-iqffc19-shard-00-00.cqagqcu.mongodb.net:27017,ac-iqffc19-shard-00-01.cqagqcu.mongodb.net:27017,ac-iqffc19-shard-00-02.cqagqcu.mongodb.net:27017/?ssl=true&replicaSet=atlas-14d61p-shard-0&authSource=admin&retryWrites=true&w=majority&appName=PruebaTFG";
        ...
        public async Task<List<Incidencia>> OrdenarPrioridadDesc(List<Incidencia> incidencias)
        {
            return incidencias.OrderByDescending(incidencia => incidencia.Prioridad).ToList();
        }

        public async Task<List<Incidencia>> OrdenarPrioridadAsc(List<Incidencia> incidencias)
        {
            return incidencias.OrderBy(incidencia => incidencia.Prioridad).ToList();
        }
        ...
        public async Task<List<TipoDispositivo>> OrdenarTiposDis(List<TipoDispositivo> dispositivos)
        {
            return dispositivos.OrderBy(dispositivos => dispositivos.TiposDisp).ToList();
        }
