...
@dso_cache = dso_local local_unnamed_addr global [760 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 786548789, ; hash 0x2ee1c835, from name: libaot-Incidenciapp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1800558761, ; hash 0x6b5258a9, from name: Incidenciapp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Incidenciapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 295
	...
	%struct.DSOCacheEntry {
		i64 2941791554, ; hash 0xaf582d42, from name: libaot-Incidenciapp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Incidenciapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 509
	...
	%struct.DSOCacheEntry {
		i64 3070839242, ; hash 0xb70949ca, from name: aot-Incidenciapp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Incidenciapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 543
	...
	%struct.DSOCacheEntry {
		i64 3079732561, ; hash 0xb790fd51, from name: aot-Incidenciapp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Incidenciapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 548
	...
	%struct.DSOCacheEntry {
		i64 3526887066, ; hash 0xd238069a, from name: Incidenciapp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Incidenciapp.dll.so
		ptr null; void* handle (0x0)
	}, ; 629
